...
export default function LULCMap() {
  ...
  return (
    ...
    >
      {/* Sidebar */}
      <aside
        className="w-96 bg-white/95 backdrop-blur-sm shadow-xl border-r border-slate-200 p-6 flex flex-col gap-6 overflow-y-auto"
        style={{ maxHeight: "calc(100vh - 60px)" }}
      >
        {/* Header */}
        <div className="space-y-2">
